...
func CloneContext(ctx context.Context) context.Context {
	...
	// marker flag and appends the <!FINAL_ANSWER> constraint. It is not
	// part of the centralized clone table, so handle it explicitly here.
	if v := ctx.Value(types.FinalAnswerMarkerContextKey); v != nil {
		newCtx = context.WithValue(newCtx, types.FinalAnswerMarkerContextKey, v)
	}
