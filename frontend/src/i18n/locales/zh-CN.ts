export default {
  ...
  agentEditor: {
    ...
    tools: {
      ...
      browseFolders: '浏览文件夹',
      browseFoldersDesc: '列出知识库的文件夹树结构',
      readFolderSummary: '读取文件夹摘要',
      readFolderSummaryDesc: '读取指定文件夹的LLM生成摘要',
      dataAnalysis: '数据分析',
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      issueAiLinter: 'AI 巡检',
      issueUserFeedback: '对话反哺',
      userFeedbackPanelTitle: '对话反哺内容',
      issueIgnore: '忽略误报',
    ...
    indexing: {
      ...
      conflictTitle: '冲突检测',
      conflictDesc: '文档上传后自动检测同知识库内不同文件的矛盾内容，可在「管理与审计 → 冲突裁决」中处理',
      folderGovernanceTitle: '文件级文件夹治理',
      folderGovernanceDesc: '启用文件级文件夹树、文件夹摘要与治理报告，支持按文件夹筛选与检索',
      userFeedbackTitle: '用户反哺 Wiki',
      userFeedbackDesc: '开启后，对话中的新增事实信息将自动沉淀到 Wiki 页面（需先开启 Wiki 索引）',
    ...
    conflict: {
      title: '冲突裁决队列',
      description: '展示同知识库内文件之间的内容冲突，可在此裁决「保留双方 / 以新为准 / 以旧为准」。',
      refresh: '刷新',
      loadError: '冲突记录加载失败',
      resolveSuccess: '裁决成功',
      resolveError: '裁决失败',
      ...
      statResolved: '已裁决',
      filterPending: '待裁决',
      filterUnresolved: '未裁决',
      colType: '类型',
      colContentA: '新文件内容 (A)',
      colContentB: '既有文件内容 (B)',
      colReason: '判定理由',
      colTime: '检测时间',
      colActions: '操作',
      typeFactContradiction: '事实矛盾',
      typePartialContradiction: '局部矛盾',
      typeVersionUpdate: '版本更新',
      statusKeepBoth: '保留双方',
      statusNewer: '以新为准',
      statusOlder: '以旧为准',
      statusNotConflict: '非冲突',
      keepBoth: '保留双方',
      newerWins: '以新为准',
      olderWins: '以旧为准',
      notConflict: '非冲突',
      confirmKeepBoth: '保留双方，不清除降权？',
      confirmNewer: '以新文件为准，禁用旧文件冲突片段？',
      confirmOlder: '以既有文件为准，禁用新文件冲突片段？',
      confirmNotConflict: '标记为非冲突，清除降权？',
      viewDetail: '查看详情',
      cellTip: '单元格内容可滚动，点击行查看完整',
      detailTitle: '冲突详情',
      detailStatus: '状态',
      detailType: '类型',
      detailReason: '判定理由',
      detailKnowledgeA: '新文件 ID',
      detailChunkA: '新文件片段 ID',
      detailKnowledgeB: '既有文件 ID',
      detailChunkB: '既有文件片段 ID',
      detailDetectedAt: '检测时间',
      detailResolvedAt: '裁决时间'
    },
    folder: {
      tabTree: '文件夹',
      tabSummary: '摘要',
      ...
      treeTip: '点击文件夹查看摘要；可用右侧按钮新建/重命名/删除',
      empty: '暂无文件夹，先新建一个根文件夹吧',
      selectFolderTip: '请在左侧选择一个文件夹以查看摘要',
      generateSummary: '生成摘要',
      forceRefresh: '强制刷新',
      refreshReport: '刷新报告',
      editSummary: '编辑摘要',
      editSummaryTitle: '编辑文件夹摘要',
      editSummaryPlaceholder: '在此编写文件夹的结构化概述……',
      editError: '保存摘要失败',
      generateQueued: '摘要生成已排队，稍后自动刷新',
      refreshQueued: '已强制刷新摘要',
      generateError: '摘要生成失败',
      rename: '重命名',
      renameError: '重命名失败',
      deleteTitle: '删除文件夹',
      deleteTip: '确定删除「{name}」吗？其中的文件将移动到上级文件夹。',
      deleteSuccess: '文件夹已删除',
      deleteError: '删除文件夹失败',
      moveFiles: '移动文件',
      moveFilesTitle: '将文件移入文件夹',
      moveInto: '移动文件到「{name}」',
      moveTip: '将移动 {count} 个文件到「{folder}」',
      moveIdsPlaceholder: '输入文件 ID，逗号分隔',
      moveIdsRequired: '请输入至少一个文件 ID',
      moveSuccess: '文件已移动',
      moveError: '移动文件失败',
      rootFolder: '根文件夹（无文件夹）',
      loadError: '文件夹加载失败',
      statusNone: '未生成',
      statusPending: '排队中',
      ...
      govEmptyNone: '没有空文件夹',
      govImbalance: '文件过多',
      govImbalanceNone: '没有文件过多的文件夹',
      govStale: '摘要过期',
      govStaleNone: '没有过期的摘要',
      govDuplicate: '跨文件夹重复',
      govDuplicateNone: '没有跨文件夹重复的文件',
      govDeep: '层级过深',
      govDeepNone: '没有层级过深的文件夹',
      govFileCount: '文件数',
      govGenerated: '生成时间',
      govDepth: '层级',
      govLoadError: '治理报告加载失败'
    },
    citationStats: {
      title: '引用统计',
  ...
  knowledgeBase: {
    ...
    tagLabel: '标签',
    tagPlaceholder: '请选择标签',
    pushAllowedLabel: '允许推送',
    pushAllowedTooltip: '开启后，智能体可以通过工具推送该文件或生成下载链接；关闭后，试图推送该文件或生成下载链接时将被拒绝。',
    pushAllowedEnabled: '已开启文件推送',
    pushAllowedDisabled: '已关闭文件推送',
    pushAllowedToggleFailed: '切换推送状态失败',
    noTags: '暂无标签',
  ...
  knowledge: {
    ...
    editedAt: '编辑时间',
    version: '版本',
    manualEditNotice: '此摘要已人工编辑，自动重算已暂停。点击"刷新摘要"可重新生成。',
    summaryReady: '摘要已生成',
    summaryPending: '摘要生成中',
    summaryManagement: '摘要管理',
    governanceReport: '治理报告',
    emptyFolder: '此文件夹为空',
    emptyFolders: '空文件夹',
    imbalancedFolders: '失衡文件夹',
    staleSummaries: '过期摘要',
    duplicateFiles: '重复文件',
    deepFolders: '层级过深',
    folderGovernance: '文件夹治理',
    createFolder: '新建文件夹',
    folderName: '文件夹名称',
    folderNamePlaceholder: '请输入文件夹名称',
    createFolderSuccess: '文件夹已创建',
    createFolderFailed: '创建文件夹失败',
    refreshStaleSummaries: '刷新过期摘要',
    refreshStaleSummariesSuccess: '过期摘要刷新任务已提交',
    noStaleSummaries: '暂无过期摘要',
    governanceEmpty: '暂无文件夹治理数据',
    renameFolder: '重命名',
    moveFolder: '移动文件夹',
    deleteFolder: '删除文件夹',
    moveToFolder: '移到文件夹',
    moveToRoot: '移到根目录',
    scopeSearchInFolder: '在此文件夹内检索',
    files: '个文件',
    backToParent: '返回上级',
    uploadFiles: '上传文件',
    viewSummary: '查看摘要',
    refreshReport: '刷新报告',
    govEmptyNone: '没有空文件夹',
    govImbalanceNone: '没有失衡文件夹',
    govStaleNone: '没有过期的摘要',
    govDuplicateNone: '没有重复文件',
    govDeepNone: '没有层级过深的文件夹',
    governancePanel: '文件夹治理'
  }
}
