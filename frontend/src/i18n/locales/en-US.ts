export default {
  ...
  knowledgeBase: {
    ...
    pushAllowedLabel: 'Allow Push',
    pushAllowedTooltip: 'When enabled, the agent may push this file or generate a download link for it. When disabled, any push attempt or download-link generation for this file will be rejected.',
    pushAllowedEnabled: 'File push enabled',
    pushAllowedDisabled: 'File push disabled',
    pushAllowedToggleFailed: 'Failed to toggle push permission',
    noTags: 'No tags',
  ...
  knowledgeEditor: {
    ...
    conflict: {
      ...
      description: 'Content conflicts detected between files in this knowledge base. Adjudicate with "Keep both / New wins / Old wins".',
      refresh: 'Refresh',
      ...
      colType: 'Type',
      colContentA: 'New file content (A)',
      colContentB: 'Existing file content (B)',
      colReason: 'Reason',
      colTime: 'Detected at',
      colActions: 'Actions',
      typeFactContradiction: 'Fact contradiction',
      typePartialContradiction: 'Partial contradiction',
      typeVersionUpdate: 'Version update',
      statusKeepBoth: 'Keep both',
      statusNewer: 'New wins',
      statusOlder: 'Old wins',
      statusNotConflict: 'Not a conflict',
      keepBoth: 'Keep both',
      newerWins: 'New wins',
      olderWins: 'Old wins',
      notConflict: 'Not a conflict',
      confirmKeepBoth: 'Keep both and clear the penalty?',
      confirmNewer: 'Use the new file and disable the old conflicting chunk?',
      confirmOlder: 'Use the existing file and disable the new conflicting chunk?',
      confirmNotConflict: 'Mark as not a conflict and clear the penalty?',
      viewDetail: 'View detail',
      cellTip: 'Cells are scrollable; click a row to see the full content',
      detailTitle: 'Conflict detail',
      detailStatus: 'Status',
      detailType: 'Type',
      detailReason: 'Reason',
      detailKnowledgeA: 'New file ID',
      detailChunkA: 'New chunk ID',
      detailKnowledgeB: 'Existing file ID',
      detailChunkB: 'Existing chunk ID',
      detailDetectedAt: 'Detected at',
    ...
    folder: {
      ...
      treeTip: 'Click a folder to view its summary; use the buttons to create/rename/delete',
      empty: 'No folders yet. Create a root folder to get started.',
      selectFolderTip: 'Select a folder from the tree to view its summary',
      generateSummary: 'Generate summary',
      forceRefresh: 'Force refresh',
      refreshReport: 'Refresh report',
      editSummary: 'Edit summary',
      editSummaryTitle: 'Edit folder summary',
      editSummaryPlaceholder: 'Write a structured overview of this folder…',
      editError: 'Failed to save summary',
      generateQueued: 'Summary generation queued; it will refresh automatically',
      refreshQueued: 'Summary refresh forced',
      generateError: 'Failed to generate summary',
      rename: 'Rename',
      renameError: 'Failed to rename',
      deleteTitle: 'Delete folder',
      deleteTip: 'Delete "{name}"? Its files will move to the parent folder.',
      deleteSuccess: 'Folder deleted',
      deleteError: 'Failed to delete folder',
      moveFiles: 'Move files',
      moveFilesTitle: 'Move files into folder',
      moveInto: 'Move files to "{name}"',
      moveTip: 'Move {count} file(s) to "{folder}"',
      moveIdsPlaceholder: 'Enter file IDs, comma-separated',
      moveIdsRequired: 'Enter at least one file ID',
      moveSuccess: 'Files moved',
      moveError: 'Failed to move files',
      rootFolder: 'Root folder (no folder)',
      ...
      noSummary: 'This folder has no summary yet',
      govEmpty: 'Empty folders',
      govEmptyNone: 'No empty folders',
      govImbalance: 'Too many files',
      govImbalanceNone: 'No over-full folders',
      govStale: 'Stale summaries',
      govStaleNone: 'No stale summaries',
      govDuplicate: 'Cross-folder duplicates',
      govDuplicateNone: 'No cross-folder duplicate files',
      govDeep: 'Over-deep hierarchy',
      govDeepNone: 'No over-deep folders',
      govFileCount: 'Files',
      govGenerated: 'Generated',
      govDepth: 'Depth',
      govLoadError: 'Failed to load governance report'
    },
    citationStats: {
    ...
    sidebar: {
      ...
      conflicts: 'Conflict Adjudication'
    },
    errors: {
    ...
    indexing: {
      ...
      conflictTitle: 'Conflict Detection',
      conflictDesc: 'Automatically detect contradictions between files in the same KB after upload. Manage them under "Management & Audit → Conflict Adjudication".',
      folderGovernanceTitle: 'File-level Folder Governance',
      folderGovernanceDesc: 'Enable the file-level folder tree, folder summaries, and governance reports; filter and retrieve by folder.',
      userFeedbackTitle: 'User Feedback to Wiki',
      userFeedbackDesc: 'When enabled, new factual info in conversations is automatically appended to Wiki pages (requires Wiki indexing).',
    ...
    wikiBrowser: {
      ...
      issueUserFeedback: 'Chat Feedback',
      userFeedbackPanelTitle: 'Chat Feedback Content',
  ...
  agentEditor: {
    ...
    tools: {
      ...
      browseFoldersDesc: 'List the folder tree structure of the knowledge base',
      readFolderSummary: 'Read Folder Summary',
      readFolderSummaryDesc: 'Read the LLM-generated summary of a specified folder',
      dataAnalysis: 'Data Analysis',
  ...
  knowledge: {
    ...
    editedAt: 'Edited at',
    version: 'Version',
    manualEditNotice: 'This summary was manually edited; auto-regeneration is paused. Click "Refresh summary" to regenerate.',
    summaryReady: 'Summary ready',
    summaryPending: 'Generating summary',
    summaryManagement: 'Summary management',
    governanceReport: 'Governance report',
    emptyFolder: 'This folder is empty',
    emptyFolders: 'Empty folders',
    imbalancedFolders: 'Imbalanced folders',
    staleSummaries: 'Stale summaries',
    duplicateFiles: 'Duplicate files',
    deepFolders: 'Over-deep folders',
    folderGovernance: 'Folder governance',
    createFolder: 'New folder',
    folderName: 'Folder name',
    folderNamePlaceholder: 'Enter folder name',
    createFolderSuccess: 'Folder created',
    createFolderFailed: 'Failed to create folder',
    refreshStaleSummaries: 'Refresh stale summaries',
    refreshStaleSummariesSuccess: 'Stale summary refresh submitted',
    noStaleSummaries: 'No stale summaries',
    governanceEmpty: 'No folder governance data yet',
    renameFolder: 'Rename',
    moveFolder: 'Move folder',
    deleteFolder: 'Delete folder',
    moveToFolder: 'Move to folder',
    moveToRoot: 'Move to root',
    scopeSearchInFolder: 'Search within this folder',
    files: 'files',
    ...
    refreshReport: 'Refresh report',
    govEmptyNone: 'No empty folders',
    govImbalanceNone: 'No imbalanced folders',
    govStaleNone: 'No stale summaries',
    govDuplicateNone: 'No duplicate files',
    govDeepNone: 'No over-deep folders',
    governancePanel: 'Folder governance'
  }
}
