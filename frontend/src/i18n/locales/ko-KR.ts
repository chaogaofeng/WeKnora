export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      issueUserFeedback: '대화 피드백',
      userFeedbackPanelTitle: '대화 피드백 내용',
      issueIgnore: '오탐지 무시',
    ...
    indexing: {
      ...
      conflictTitle: '충돌 감지',
      conflictDesc: '문서 업로드 후 동일 지식베이스 내 파일 간 모순을 자동 감지합니다. 「관리 및 감사 → 충돌 심의」에서 처리할 수 있습니다.',
      folderGovernanceTitle: '파일 수준 폴더 관리',
      folderGovernanceDesc: '파일 수준 폴더 트리, 폴더 요약 및 관리 보고서를 활성화하고 폴더별로 필터링·검색합니다.',
      userFeedbackTitle: 'Wiki 사용자 피드백',
      userFeedbackDesc: '활성화하면 대화의 새로운 사실 정보가 자동으로 Wiki 페이지에 추가됩니다(Wiki 인덱싱 필요).',
    ...
    conflict: {
      title: '충돌 심의 큐',
      description: '지식베이스 내 파일 간에 감지된 내용 충돌입니다. 「모두 유지 / 새 파일 우선 / 기존 파일 우선 / 비충돌」로 심의하세요.',
      refresh: '새로고침',
      loadError: '충돌 목록을 불러오지 못했습니다',
      resolveSuccess: '심의 완료',
      resolveError: '심의 실패',
      statPending: '대기 중',
      statResolved: '심의 완료',
      filterPending: '대기 중',
      filterUnresolved: '미해결',
      colType: '유형',
      colContentA: '새 파일 내용 (A)',
      colContentB: '기존 파일 내용 (B)',
      colReason: '판정 근거',
      colTime: '감지 시간',
      colActions: '작업',
      typeFactContradiction: '사실 모순',
      typePartialContradiction: '부분 모순',
      typeVersionUpdate: '버전 업데이트',
      statusKeepBoth: '모두 유지',
      statusNewer: '새 파일 우선',
      statusOlder: '기존 파일 우선',
      statusNotConflict: '비충돌',
      keepBoth: '모두 유지',
      newerWins: '새 파일 우선',
      olderWins: '기존 파일 우선',
      notConflict: '비충돌',
      confirmKeepBoth: '모두 유지하고 페널티를 해제하시겠습니까?',
      confirmNewer: '새 파일을 기준으로 기존 충돌 조각을 비활성화하시겠습니까?',
      confirmOlder: '기존 파일을 기준으로 새 충돌 조각을 비활성화하시겠습니까?',
      confirmNotConflict: '비충돌로 표시하고 페널티를 해제하시겠습니까?',
      viewDetail: '상세 보기',
      cellTip: '셀 내부는 스크롤되며, 행을 클릭하면 전체 내용을 볼 수 있습니다',
      detailTitle: '충돌 상세',
      detailStatus: '상태',
      detailType: '유형',
      detailReason: '판정 근거',
      detailKnowledgeA: '새 파일 ID',
      detailChunkA: '새 청크 ID',
      detailKnowledgeB: '기존 파일 ID',
      detailChunkB: '기존 청크 ID',
      detailDetectedAt: '감지 시간',
      detailResolvedAt: '심의 시간'
    },
    folder: {
      tabTree: '폴더',
      tabSummary: '요약',
      ...
      createTitle: '폴더 만들기',
      createChild: '새 하위 폴더',
      createError: '폴더 생성 실패',
      name: '폴더 이름',
      namePlaceholder: '폴더 이름 입력',
      nameRequired: '폴더 이름을 입력하세요',
      treeTip: '폴더를 클릭하여 요약을 확인하고, 버튼으로 생성/이름변경/삭제할 수 있습니다',
      empty: '폴더가 없습니다. 루트 폴더를 먼저 만드세요.',
      selectFolderTip: '트리에서 폴더를 선택하여 요약을 확인하세요',
      generateSummary: '요약 생성',
      forceRefresh: '강제 새로고침',
      refreshReport: '보고서 새로고침',
      editSummary: '요약 편집',
      editSummaryTitle: '폴더 요약 편집',
      editSummaryPlaceholder: '이 폴더의 구조적 개요를 작성하세요…',
      editError: '요약 저장 실패',
      generateQueued: '요약 생성이 대기 중이며 자동으로 새로고침됩니다',
      refreshQueued: '요약을 강제 새로고침했습니다',
      generateError: '요약 생성 실패',
      rename: '이름 변경',
      renameError: '이름 변경 실패',
      deleteTitle: '폴더 삭제',
      deleteTip: '"{name}"을(를) 삭제하시겠습니까? 안의 파일은 상위 폴더로 이동합니다.',
      deleteSuccess: '폴더가 삭제되었습니다',
      deleteError: '폴더 삭제 실패',
      moveFiles: '파일 이동',
      moveFilesTitle: '폴더로 파일 이동',
      moveInto: '"{name}"(으)로 파일 이동',
      moveTip: '{count}개 파일을 "{folder}"(으)로 이동',
      moveIdsPlaceholder: '파일 ID 입력 (쉼표 구분)',
      moveIdsRequired: '파일 ID를 하나 이상 입력하세요',
      moveSuccess: '파일이 이동되었습니다',
      moveError: '파일 이동 실패',
      rootFolder: '루트 폴더 (폴더 없음)',
      loadError: '폴더 로드 실패',
      statusNone: '미생성',
      statusPending: '대기 중',
      ...
      generatedAt: '{time} 생성',
      manualEdit: '수동 편집',
      noSummary: '이 폴더에는 요약이 없습니다',
      govEmpty: '빈 폴더',
      govEmptyNone: '빈 폴더 없음',
      govImbalance: '파일 과다',
      govImbalanceNone: '파일이 많은 폴더 없음',
      govStale: '요약 만료',
      govStaleNone: '만료된 요약 없음',
      govDuplicate: '폴더 간 중복',
      govDuplicateNone: '폴더 간 중복 파일 없음',
      govDeep: '깊은 계층',
      govDeepNone: '깊은 계층 폴더 없음',
      govFileCount: '파일 수',
      govGenerated: '생성 시간',
      govDepth: '계층',
      govLoadError: '관리 보고서 로드 실패'
    },
    citationStats: {
      title: '인용 통계',
  ...
  knowledge: {
    ...
    editedAt: '편집 시간',
    version: '버전',
    manualEditNotice: '이 요약은 수동 편집되었으며 자동 재계산이 중지되었습니다. "요약 새로고침"을 눌러 다시 생성하세요.',
    summaryReady: '요약 완료',
    summaryPending: '요약 생성 중',
    summaryManagement: '요약 관리',
    governanceReport: '관리 보고서',
    emptyFolder: '이 폴더는 비어 있습니다',
    emptyFolders: '빈 폴더',
    imbalancedFolders: '불균형 폴더',
    staleSummaries: '만료 요약',
    duplicateFiles: '중복 파일',
    deepFolders: '과다 계층',
    folderGovernance: '폴더 관리',
    createFolder: '새 폴더',
    folderName: '폴더 이름',
    folderNamePlaceholder: '폴더 이름을 입력하세요',
    createFolderSuccess: '폴더가 생성되었습니다',
    createFolderFailed: '폴더 생성에 실패했습니다',
    refreshStaleSummaries: '오래된 요약 새로고침',
    refreshStaleSummariesSuccess: '오래된 요약 새로고침 작업이 제출되었습니다',
    noStaleSummaries: '오래된 요약이 없습니다',
    governanceEmpty: '폴더 관리 데이터가 아직 없습니다',
    renameFolder: '이름 변경',
    moveFolder: '폴더 이동',
    deleteFolder: '폴더 삭제',
    moveToFolder: '폴더로 이동',
    moveToRoot: '루트로 이동',
    scopeSearchInFolder: '이 폴더 내 검색',
    files: '개 파일',
    ...
    refreshReport: '보고서 새로고침',
    govEmptyNone: '빈 폴더 없음',
    govImbalanceNone: '불균형 폴더 없음',
    govStaleNone: '만료 요약 없음',
    govDuplicateNone: '중복 파일 없음',
    govDeepNone: '과다 계층 없음',
    governancePanel: '폴더 관리'
  }
}
