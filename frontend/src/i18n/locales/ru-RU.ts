export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      issueUserFeedback: 'Обратная связь',
      userFeedbackPanelTitle: 'Контент обратной связи',
    ...
    indexing: {
      ...
      conflictTitle: 'Обнаружение конфликтов',
      conflictDesc: 'Автоматически обнаруживает противоречия между файлами в одной БЗ после загрузки. Обрабатывается в разделе «Управление и аудит → Разрешение конфликтов».',
      folderGovernanceTitle: 'Папки уровня файлов',
      folderGovernanceDesc: 'Включает дерево папок уровня файлов, сводки папок и отчёты управления; фильтрация и поиск по папкам.',
      userFeedbackTitle: 'Обратная связь пользователей в Wiki',
      userFeedbackDesc: 'При включении новая фактическая информация из диалогов автоматически добавляется на страницы Wiki (требуется индексация Wiki).',
    ...
    sidebar: {
      ...
      citation: 'Статистика цитирования',
    ...
    conflict: {
      title: 'Очередь разрешения конфликтов',
      description: 'Конфликты содержимого, обнаруженные между файлами этой БЗ. Разрешите как «Сохранить оба / Приоритет нового / Приоритет старого / Не конфликт».',
      refresh: 'Обновить',
      loadError: 'Не удалось загрузить конфликты',
      resolveSuccess: 'Разрешено',
      resolveError: 'Ошибка разрешения',
      statPending: 'Ожидают',
      statResolved: 'Разрешено',
      filterPending: 'Ожидают',
      filterUnresolved: 'Не разрешено',
      colType: 'Тип',
      colContentA: 'Содержимое нового файла (A)',
      colContentB: 'Содержимое существующего файла (B)',
      colReason: 'Причина',
      colTime: 'Обнаружено',
      colActions: 'Действия',
      typeFactContradiction: 'Фактическое противоречие',
      typePartialContradiction: 'Частичное противоречие',
      typeVersionUpdate: 'Обновление версии',
      statusKeepBoth: 'Сохранить оба',
      statusNewer: 'Новый приоритет',
      statusOlder: 'Старый приоритет',
      statusNotConflict: 'Не конфликт',
      keepBoth: 'Сохранить оба',
      newerWins: 'Новый приоритет',
      olderWins: 'Старый приоритет',
      notConflict: 'Не конфликт',
      confirmKeepBoth: 'Сохранить оба и снять штраф?',
      confirmNewer: 'Использовать новый файл и отключить старый конфликтующий фрагмент?',
      confirmOlder: 'Использовать существующий файл и отключить новый конфликтующий фрагмент?',
      confirmNotConflict: 'Пометить как не конфликт и снять штраф?',
      viewDetail: 'Подробнее',
      cellTip: 'Содержимое ячеек прокручивается; щёлкните по строке, чтобы увидеть полностью',
      detailTitle: 'Детали конфликта',
      detailStatus: 'Статус',
      detailType: 'Тип',
      detailReason: 'Причина',
      detailKnowledgeA: 'ID нового файла',
      detailChunkA: 'ID фрагмента нового файла',
      detailKnowledgeB: 'ID существующего файла',
      detailChunkB: 'ID фрагмента существующего файла',
      detailDetectedAt: 'Обнаружено',
      detailResolvedAt: 'Разрешено'
    },
    folder: {
      tabTree: 'Папки',
      tabSummary: 'Сводка',
      tabGovernance: 'Управление',
      createRoot: 'Новая корневая папка',
      createTitle: 'Создать папку',
      createChild: 'Новая подпапка',
      createError: 'Не удалось создать папку',
      name: 'Имя папки',
      namePlaceholder: 'Введите имя папки',
      nameRequired: 'Введите имя папки',
      treeTip: 'Нажмите на папку, чтобы увидеть сводку; кнопками создавайте/переименовывайте/удаляйте',
      empty: 'Папок нет. Создайте корневую папку.',
      selectFolderTip: 'Выберите папку в дереве, чтобы увидеть сводку',
      ...
      editSummaryTitle: 'Редактировать сводку папки',
      editSummaryPlaceholder: 'Напишите структурированный обзор этой папки…',
      editError: 'Не удалось сохранить сводку',
      generateQueued: 'Генерация сводки поставлена в очередь; обновится автоматически',
      refreshQueued: 'Сводка принудительно обновлена',
      generateError: 'Не удалось сгенерировать сводку',
      rename: 'Переименовать',
      renameError: 'Не удалось переименовать',
      deleteTitle: 'Удалить папку',
      deleteTip: 'Удалить «{name}»? Файлы внутри переместятся в родительскую папку.',
      deleteSuccess: 'Папка удалена',
      deleteError: 'Не удалось удалить папку',
      moveFiles: 'Переместить файлы',
      moveFilesTitle: 'Переместить файлы в папку',
      moveInto: 'Переместить файлы в «{name}»',
      moveTip: 'Переместить {count} файл(ов) в «{folder}»',
      moveIdsPlaceholder: 'Введите ID файлов через запятую',
      moveIdsRequired: 'Введите хотя бы один ID файла',
      moveSuccess: 'Файлы перемещены',
      moveError: 'Не удалось переместить файлы',
      rootFolder: 'Корневая папка (без папки)',
      loadError: 'Не удалось загрузить папки',
      statusNone: 'Не создано',
      statusPending: 'В очереди',
      statusProcessing: 'Создание',
      statusCompleted: 'Готово',
      statusFailed: 'Ошибка',
      generatedAt: 'Создано {time}',
      manualEdit: 'Ручное редактирование',
      noSummary: 'У этой папки ещё нет сводки',
      govEmpty: 'Пустые папки',
      govEmptyNone: 'Нет пустых папок',
      govImbalance: 'Слишком много файлов',
      govImbalanceNone: 'Нет переполненных папок',
      govStale: 'Устаревшие сводки',
      govStaleNone: 'Нет устаревших сводок',
      govDuplicate: 'Дубликаты между папками',
      govDuplicateNone: 'Нет дубликатов между папками',
      govDeep: 'Глубокая иерархия',
      govDeepNone: 'Нет глубоких папок',
      govFileCount: 'Файлы',
      govGenerated: 'Создано',
      govDepth: 'Уровень',
      govLoadError: 'Не удалось загрузить отчёт об управлении'
    },
    citationStats: {
      title: 'Статистика цитирования',
      desc: 'Подсчёт того, как часто файлы этой базы знаний цитируются в ответах, для оценки популярности и ценности файлов.',
      totalCount: 'Всего цитирований',
      recentCount: 'За 30 дней',
      zeroCitedCount: 'Файлы без цитирований',
      topCitedTitle: 'Самые цитируемые файлы',
      zeroCitedTitle: 'Никогда не цитировавшиеся файлы',
      noTopCited: 'Данных о цитировании пока нет. Они появятся здесь после генерации ссылок в ответах.',
      noZeroCited: 'В этой базе знаний нет файлов без цитирований.',
      times: 'раз',
      loadFailed: 'Не удалось загрузить статистику цитирования',
      refresh: 'Обновить'
    }
  },
  embedPublish: {
  ...
  knowledge: {
    ...
    folderSummary: 'Сводка папки',
    editSummary: 'Редактировать сводку',
    refreshSummary: 'Обновить сводку',
    generatedAt: 'Создано',
    editedAt: 'Изменено',
    version: 'Версия',
    manualEditNotice: 'Эта сводка отредактирована вручную; автоматическое пересоздание приостановлено. Нажмите «Обновить сводку», чтобы сгенерировать заново.',
    summaryReady: 'Сводка готова',
    summaryPending: 'Создание сводки',
    summaryManagement: 'Управление сводками',
    governanceReport: 'Отчёт об управлении',
    emptyFolder: 'Эта папка пуста',
    emptyFolders: 'Пустые папки',
    imbalancedFolders: 'Несбалансированные папки',
    staleSummaries: 'Устаревшие сводки',
    duplicateFiles: 'Дубликаты',
    deepFolders: 'Глубокая иерархия',
    folderGovernance: 'Управление папками',
    createFolder: 'Новая папка',
    folderName: 'Имя папки',
    folderNamePlaceholder: 'Введите имя папки',
    createFolderSuccess: 'Папка создана',
    createFolderFailed: 'Не удалось создать папку',
    refreshStaleSummaries: 'Обновить устаревшие сводки',
    refreshStaleSummariesSuccess: 'Задача обновления устаревших сводок отправлена',
    noStaleSummaries: 'Нет устаревших сводок',
    governanceEmpty: 'Нет данных об управлении папками',
    renameFolder: 'Переименовать',
    moveFolder: 'Переместить папку',
    deleteFolder: 'Удалить папку',
    moveToFolder: 'Переместить в папку',
    moveToRoot: 'В корень',
    scopeSearchInFolder: 'Искать в этой папке',
    files: 'файлов',
    backToParent: 'На уровень вверх',
    uploadFiles: 'Загрузить файлы',
    viewSummary: 'Просмотреть сводку',
    refreshReport: 'Обновить отчёт',
    govEmptyNone: 'Нет пустых папок',
    govImbalanceNone: 'Нет несбалансированных папок',
    govStaleNone: 'Нет устаревших сводок',
    govDuplicateNone: 'Нет дубликатов',
    govDeepNone: 'Нет глубоких папок',
    governancePanel: 'Управление папками'
  }
}
